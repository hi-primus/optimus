...
[![Logo Optimus](https://raw.githubusercontent.com/hi-primus/optimus/develop-22.10/images/optimus-logo.png)](https://hi-optimus.com)
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/hi-primus/optimus/develop-22.10?filepath=https%3A%2F%2Fraw.githubusercontent.com%2Fhi-primus%2Foptimus%2Fdevelop-22.10%2Fexamples%2F10_min_to_optimus.ipynb)
...
You can go to the 10 minutes to Optimus [notebook](https://github.com/hi-primus/optimus/blob/develop-22.10/examples/10_min_to_optimus.ipynb) where you can find the basic to start working.

Also you can go to [Examples](https://github.com/hi-primus/optimus/tree/develop-22.10/examples/examples.md) and found specific notebooks about data cleaning, data munging, profiling, data enrichment and how to create ML and DL models.

Besides check the [Cheat Sheet](https://htmlpreview.github.io/?https://github.com/hi-primus/optimus/blob/develop-22.10/docs/cheatsheet/optimus_cheat_sheet.html)
...
display(df)
```
![](https://github.com/hi-primus/optimus/tree/develop-22.10/readme/images/table.png)
...
If you have issues, see our [Troubleshooting Guide](https://github.com/hi-primus/optimus/tree/develop-22.10/troubleshooting.md)
...
* [Documentation](https://github.com/hi-primus/optimus/tree/develop-22.10/docs/source) updates, enhancements, designs, or   bugfixes. 
* Spelling or grammar fixes. 
* README.md corrections or redesigns. 
* Adding unit, or functional [tests](https://github.com/hi-primus/optimus/tree/develop-22.10/tests)  
