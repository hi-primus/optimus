...
_list_types = [str(DataFrameTypeList), str(InternalDataFrameTypeList), str(MaskDataFrameTypeList),
               str(ConnectionTypeList), str(ClustersTypeList), str(ModelTypeList)]

_types = [str(DataFrameType), str(InternalDataFrameType), str(MaskDataFrameType), str(ConnectionType),
          str(ClustersType), str(ModelType)]
