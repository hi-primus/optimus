...
from optimus.spark.audf import filter_row_by_data_type as fbdt
from optimus.spark.helpers.check import is_list_of_str_or_int, is_list_of_tuples, is_list_of_dataframes, is_dataframe
from optimus.spark.helpers.columns import parse_columns, validate_columns_names
from optimus.spark.helpers.converter import one_list_to_val
...
def rows(self):
    ...
    class Rows:
        ...
        def unnest(input_cols):
            ...
            :return:
            """
            input_cols = parse_columns(source_df, input_cols)[0]
            df = source_df
