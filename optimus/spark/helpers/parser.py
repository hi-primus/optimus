from optimus.spark.helpers.constants import SPARK_DTYPES_DICT, SPARK_SHORT_DTYPES, PYTHON_SHORT_TYPES, \
...
def parse_col_names_funcs_to_keys(data):
    from optimus.spark.helpers.check import is_numeric, is_nan
