...
from optimus.spark.helpers.check import is_str, is_list, is_, is_bool, is_datetime, \
    is_date, is_binary
from optimus.spark.helpers.converter import one_list_to_val, str_to_boolean, str_to_date, str_to_array, val_to_list
from optimus.spark.helpers.logger import logger
from optimus.spark.helpers.parser import parse_spark_class_dtypes
...
def setup_google_colab():
    ...
    :return:
    """
    from optimus.spark.helpers.constants import JAVA_PATH_COLAB, SPARK_PATH_COLAB, SPARK_URL, SPARK_FILE
