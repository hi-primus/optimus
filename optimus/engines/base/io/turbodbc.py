...
class TURBODBC:
    ...
    def __init__(self, host, database, user, password, port=None, driver=None, schema="public", oracle_tns=None,
        ...
        :param host:
        :param database: database type Mysql. Postgres, etc
        :param user:
        :param password:
        :param port:
        :param driver:
        :param schema:
        :param oracle_tns:
        :param oracle_service_name:
        :param oracle_sid:
        :param presto_catalog:
        :param cassandra_keyspace:
        :param cassandra_table:
        """
        ...
        self.connection = connect(driver=driver,
                             server=host,
                             port=str(self.port),
                             database=database,
                             uid=user,
