...
class BaseConstants:
    ...
    OPTIMUS_TO_INTERNAL = {ProfilerDataTypes.INT.value: "int",
                           ...
                           ProfilerDataTypes.IPV4_ADDRESS.value: "str",
                           ProfilerDataTypes.IPV6_ADDRESS.value: "str",
                           ProfilerDataTypes.UUID.value: "str",
                           ProfilerDataTypes.BAN.value: "str",
    ...
    @property
    def OBJECT_INTERNAL_TYPES(self):
        return [ProfilerDataTypes.OBJECT.value] + [item[0] for item in self.INTERNAL_TO_OPTIMUS.items() if
                                                   item[1] == ProfilerDataTypes.OBJECT.value]
