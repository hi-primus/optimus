...
t = Test(op, source_df, "df_meta", imports=["from pyspark.ml.linalg import Vectors, VectorUDT, DenseVector",
                                        "import numpy as np",
                                        "nan = np.nan",
                                        "import datetime",
                                        "from pyspark.sql import functions as F",
                                        "from optimus.profiler.profiler import Profiler",
                                        ], path = "df_meta", final_path="..")
...
t.create(None, "cols.set_meta", None, 'df', None, source_df, string_col)
