...
class TestDataFrameCols(object):
    ...
    def test_cols_min_all_columns():
        ...
        expected_value = {'names': {'min': 'Jazz'}, 'height(ft)': {'min': 13}, 'function': {'min': 'Battle Station'},
                          'rank': {'min': 7}, 'age': {'min': 5000000}, 'weight(t)': {'min': 1.7999999523162842},
                          ...
                          'Tiemstamp': {'min': datetime.datetime(2014, 6, 24, 0, 0)}, 'Cybertronian': {'min': True},
    ...
    def test_cols_max_all_columns():
        ...
        expected_value = {'names': {'max': 'ironhide&'}, 'height(ft)': {'max': 300}, 'function': {'max': 'Security'},
                          'rank': {'max': 10}, 'age': {'max': 5000000}, 'weight(t)': {'max': 5.699999809265137},
                          ...
                          'Tiemstamp': {'max': datetime.datetime(2014, 6, 24, 0, 0)}, 'Cybertronian': {'max': True},
    ...
    def test_cols_range_all_columns():
        ...
        expected_value = {'names': {'min': 'Jazz', 'max': 'ironhide&'}, 'height(ft)': {'min': 13, 'max': 300},
                          ...
                          'age': {'min': 5000000, 'max': 5000000},
                          'weight(t)': {'min': 1.7999999523162842, 'max': 5.699999809265137},
                          ...
                          'Cybertronian': {'min': True, 'max': True},
    ...
    def test_cols_median_all_columns():
        ...
        expected_value = {'age': 5000000.0, 'weight(t)': 1.7999999523162842, 'height(ft)': 13.0, 'rank': 7.0}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_percentile():
        actual_df = source_df.cols.percentile('height(ft)')
        expected_value = {0.05: 13.0, 0.25: 13.0}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_percentile_all_columns():
        actual_df = source_df.cols.percentile('*')
        expected_value = {'age': {0.05: 5000000.0, 0.25: 5000000.0},
                          'weight(t)': {0.05: 1.7999999523162842, 0.25: 1.7999999523162842},
                          'height(ft)': {0.05: 13.0, 0.25: 13.0}, 'rank': {0.05: 7.0, 0.25: 7.0}}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_mad():
        actual_df = source_df.cols.mad('height(ft)')
        expected_value = {'height(ft)': {'mad': 0.0}}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_mad_all_columns():
        actual_df = source_df.cols.mad('*')
        expected_value = {'age': {'mad': 0.0}, 'weight(t)': {'mad': 0.0}, 'height(ft)': {'mad': 0.0},
                          'rank': {'mad': 0.0}}
        assert (expected_value == actual_df)
    ...
    def test_cols_std():
        ...
        expected_value = 124.92677855447965
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_std_all_columns():
        actual_df = source_df.cols.std('*')
        expected_value = {'age': {'stddev': 0.0}, 'weight(t)': {'stddev': 1.6471186685989825},
                          'height(ft)': {'stddev': 124.92677855447965}, 'rank': {'stddev': 1.3662601021279464}}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_kurt():
        actual_df = source_df.cols.kurt('height(ft)')
        expected_value = 0.23771659716646143
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_kurt_all_columns():
        actual_df = source_df.cols.kurt('*')
        expected_value = {'age': {'kurtosis': nan}, 'weight(t)': {'kurtosis': -1.4364059228351893},
                          'height(ft)': {'kurtosis': 0.23771659716646143}, 'rank': {'kurtosis': -1.4999999999999993}}
        assert (expected_value == actual_df)
    ...
    def test_cols_mean_all_columns():
        ...
        expected_value = {'age': {'mean': 5000000.0}, 'weight(t)': {'mean': 3.5599999904632567},
                          'height(ft)': {'mean': 76.8}, 'rank': {'mean': 8.333333333333334}}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_skewness():
        actual_df = source_df.cols.skewness('height(ft)')
        expected_value = 1.4907416740297426
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_skewness_all_columns():
        actual_df = source_df.cols.skewness('*')
        expected_value = {'age': {'skewness': nan}, 'weight(t)': {'skewness': 0.06521092918642772},
                          'height(ft)': {'skewness': 1.4907416740297426}, 'rank': {'skewness': 0.38180177416060634}}
        assert (expected_value == actual_df)
    ...
    def test_cols_sum_all_columns():
        ...
        expected_value = {'age': {'sum': 30000000}, 'weight(t)': {'sum': 17.799999952316284},
                          'height(ft)': {'sum': 384}, 'rank': {'sum': 50}}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_variance():
        actual_df = source_df.cols.variance('height(ft)')
        expected_value = 15606.699999999999
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_variance_all_columns():
        actual_df = source_df.cols.variance('*')
        expected_value = {'age': {'variance': 0.0}, 'weight(t)': {'variance': 2.7129999084472844},
                          'height(ft)': {'variance': 15606.699999999999}, 'rank': {'variance': 1.8666666666666665}}
        assert (expected_value == actual_df)
    ...
    def test_cols_count_na_all_columns():
        ...
        expected_value = {'age': 0, 'weight(t)': 1, 'height(ft)': 1, 'rank': 0}
        assert (expected_value == actual_df)
    ...
    def test_cols_count_zeros_all_columns():
        ...
        expected_value = {'age': 0, 'weight(t)': 0, 'height(ft)': 0, 'rank': 0}
        assert (expected_value == actual_df)
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ...
             ('height(ft)z_col_', DoubleType(), True)], [("Optim'us", 28, 'Leader', 10, 5000000, 4.300000190734863,
                                                         ...
                                                         datetime.datetime(2014, 6, 24, 0, 0), True,
                                                         bytearray(b'Security'), None, 0.40663819709275933), (
                                                         ...
                                                         datetime.date(2013, 6, 24),
                                                         datetime.datetime(2014, 6, 24, 0, 0), True,
                                                         bytearray(b'First Lieutenant'), None, 0.5106991530416938), (
                                                         ...
                                                         datetime.datetime(2014, 6, 24, 0, 0), True,
                                                         bytearray(b'Battle Station'), None, 1.7866465667540135)])
        assert (expected_df.collect() == actual_df.collect())
    ...
    def test_cols_z_score_all_columns():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ...
             ('Tiemstamp', TimestampType(), True), ('Cybertronian', BooleanType(), True),
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True),
             ('agez_col_', DoubleType(), True), ('weight(t)z_col_', DoubleType(), True),
             ('height(ft)z_col_', DoubleType(), True), ('rankz_col_', DoubleType(), True)], [("Optim'us", 28, 'Leader',
                                                                                              10, 5000000,
                                                                                              4.300000190734863,
                                                                                              '[Inochi, Convoy]',
                                                                                              '19.442735,-99.201111',
                                                                                             ...
                                                                                             datetime.datetime(2014, 6,
                                                                                                               ...
                                                                                                               0), True,
                                                                                             bytearray(b'None'), None,
                                                                                             None, 1.2992383970865535,
                                                                                             None, 1.2198750911856662),
                                                                                             ('Metroplex_)^$', 300,
                                                                                              'Battle Station', 8,
                                                                                              5000000, None,
                                                                                              '[Metroflex]', None,
    ...
    def test_cols_remove_accents_all_columns():
        actual_df = source_df.cols.remove_accents('*')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', StringType(), True), ('function', StringType(), True),
             ('rank', StringType(), True), ('age', StringType(), True), ('weight(t)', StringType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
             ...
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True)], [("Optim'us", '28.0', 'Leader',
                                                                                         ...
                                                                                         '[Megatron]', 'None',
                                                                                         '1980/04/10', '2012/05/10',
                                                                                         [None, 5700.0], '2012-05-10',
                                                                                         datetime.datetime(2014, 6, 24,
                                                                                                           0, 0),
                                                                                         'True', bytearray(b'None'),
                                                                                         None), (
                                                                                         'Metroplex_)^$', '300.0',
                                                                                         'Battle Station', '8',
                                                                                         '5000000', 'nan',
    ...
    def test_cols_remove_special_chars():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', StringType(), True), ('function', StringType(), True),
             ...
             ('attributes', ArrayType(FloatType(), True), True), ('DateType', DateType(), True),
             ('Tiemstamp', TimestampType(), True), ('Cybertronian', BooleanType(), True),
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True)], [("Optim'us", '280', 'Leader',
                                                                                          10, 5000000,
                                                                                          4.300000190734863,
                                                                                          '[Inochi, Convoy]',
                                                                                          '19.442735,-99.201111',
    ...
    def test_cols_remove_special_chars_all_columns():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', StringType(), True), ('function', StringType(), True),
             ...
             ('attributes', ArrayType(FloatType(), True), True), ('DateType', StringType(), True),
             ('Tiemstamp', TimestampType(), True), ('Cybertronian', StringType(), True),
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True)], [('Optimus', '280', 'Leader',
                                                                                          '10', '5000000',
                                                                                          '4300000190734863',
                                                                                          'Inochi Convoy',
                                                                                          '1944273599201111',
                                                                                         ...
                                                                                         None), ('Jazz', '130',
                                                                                                 ...
                                                                                                 datetime.datetime(2014,
                                                                                                                   ...
                                                                                                                   0),
                                                                                                 'True', bytearray(
                b'First Lieutenant'), None), ('Megatron', 'nan', 'None', '10', '5000000', '5699999809265137',
                                              'Megatron', 'None', '19800410', '20120510', [None, 5700.0], '20120510',
                                              datetime.datetime(2014, 6, 24, 0, 0), 'True', bytearray(b'None'), None), (
                                                                                         'Metroplex', '3000',
                                                                                         'Battle Station', '8',
                                                                                         '5000000', 'nan', 'Metroflex',
                                                                                         'None', '19800410', '20110410',
                                                                                         [91.44000244140625, None],
                                                                                         '20110410',
                                                                                         datetime.datetime(2014, 6, 24,
                                                                                                           0, 0),
    ...
    def test_cols_date_transform_all_columns():
        actual_df = source_df.cols.date_transform('yyyy/MM/dd', 'dd-MM-YYYY')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    def test_cols_years_between_multiple_columns():
        actual_df = source_df.cols.years_between('yyyyMMdd')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    def test_cols_impute_all_columns():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', FloatType(), True), ('function', StringType(), True),
             ...
             ('Tiemstamp', TimestampType(), True), ('Cybertronian', BooleanType(), True),
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True),
             ('age_impute', FloatType(), True), ('weight(t)_impute', FloatType(), True),
             ('height(ft)_impute', FloatType(), True), ('rank_impute', FloatType(), True)], [(
                                                                                             "Optim'us", 28.0, 'Leader',
                                                                                             10.0, 5000000.0,
                                                                                             4.300000190734863,
                                                                                             '[Inochi, Convoy]',
                                                                                             '19.442735,-99.201111',
                                                                                             ...
                                                                                             bytearray(
                                                                                                 b'Battle Station'),
                                                                                             None, 5000000.0,
                                                                                             3.559999942779541, 300.0,
                                                                                             8.0)])
        assert (expected_df.collect() == actual_df.collect())

    @staticmethod
    def test_cols_hist():
        actual_df = source_df.cols.hist('rank')
    ...
    def test_cols_dtypes_all_columns():
        ...
        expected_value = {'names': 'string', 'height(ft)': 'smallint', 'function': 'string', 'rank': 'tinyint',
                          'age': 'int', 'weight(t)': 'float', 'japanese name': 'string', 'last position seen': 'string',
                          'date arrival': 'string', 'last date seen': 'string', 'attributes': 'array<float>',
                          'DateType': 'date', 'Tiemstamp': 'timestamp', 'Cybertronian': 'boolean',
                          'function(binary)': 'binary', 'NullType': 'null'}
        assert (expected_value == actual_df)

    @staticmethod
    def test_cols_select_by_dtypes_str():
        actual_df = source_df.cols.select_by_dtypes('str')
        expected_df = op.create.df([('last position seen', StringType(), True), ('japanese name', StringType(), True),
                                    ('names', StringType(), True), ('date arrival', StringType(), True),
                                    ('last date seen', StringType(), True), ('function', StringType(), True)], [(
                                                                                                                '19.442735,-99.201111',
                                                                                                                '[Inochi, Convoy]',
                                                                                                                "Optim'us",
                                                                                                                '1980/04/10',
    ...
    def test_cols_select_by_dtypes_array():
        ...
        expected_df = op.create.df([('attributes', ArrayType(FloatType(), True), True)],
                                   [([8.53439998626709, 4300.0],), ([5.334000110626221, 2000.0],),
                                    ([7.924799919128418, 4000.0],), ([3.962399959564209, 1800.0],), ([None, 5700.0],),
                                    ([91.44000244140625, None],)])
        assert (expected_df.collect() == actual_df.collect())
    ...
    @staticmethod
    def test_cols_qcut():
        actual_df = source_df.cols.qcut('rank')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    def test_cols_qcut_all_columns():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ...
             ('attributes', ArrayType(FloatType(), True), True), ('DateType', DateType(), True),
             ('Tiemstamp', TimestampType(), True), ('Cybertronian', BooleanType(), True),
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True), ('age_qcut', DoubleType(), True),
             ('weight(t)_qcut', DoubleType(), True), ('height(ft)_qcut', DoubleType(), True),
             ('rank_qcut', DoubleType(), True)], [("Optim'us", 28, 'Leader', 10, 5000000, 4.300000190734863,
                                                   '[Inochi, Convoy]', '19.442735,-99.201111', '1980/04/10',
                                                   '2016/09/10', [8.53439998626709, 4300.0], datetime.date(2016, 9, 10),
                                                   datetime.datetime(2014, 6, 24, 0, 0), True, bytearray(b'Leader'),
                                                   None, 1.0, 3.0, 3.0, 2.0), (
                                                  'bumbl#ebéé  ', 17, 'Espionage', 7, 5000000, 2.0,
                                                  '[Bumble, Goldback]', '10.642707,-71.612534', '1980/04/10',
                                                  '2015/08/10', [5.334000110626221, 2000.0], datetime.date(2015, 8, 10),
                                                  datetime.datetime(2014, 6, 24, 0, 0), True, bytearray(b'Espionage'),
                                                  None, 1.0, 1.0, 2.0, 1.0), (
                                                  'ironhide&', 26, 'Security', 7, 5000000, 4.0, '[Roadbuster]',
                                                  '37.789563,-122.400356', '1980/04/10', '2014/07/10',
                                                  [7.924799919128418, 4000.0], datetime.date(2014, 6, 24),
                                                  datetime.datetime(2014, 6, 24, 0, 0), True, bytearray(b'Security'),
                                                  ...
                                                  [3.962399959564209, 1800.0], datetime.date(2013, 6, 24),
                                                  datetime.datetime(2014, 6, 24, 0, 0), True,
                                                  bytearray(b'First Lieutenant'), None, 1.0, 0.0, 1.0, 2.0)])
        assert (expected_df.collect() == actual_df.collect())

    @staticmethod
    def test_cols_clip():
        actual_df = source_df.cols.clip('rank')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
    ...
    def test_cols_replace():
        actual_df = source_df.cols.replace('function', 'Match')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    def test_cols_replace_all_columns():
        actual_df = source_df.cols.replace('*', 'Match')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    def test_cols_apply_expr_all_columns():
        actual_df = source_df.cols.apply_expr()
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', IntegerType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    def test_cols_append_number():
        actual_df = source_df.cols.append('new col')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    @staticmethod
    def test_cols_append_advance():
        actual_df = source_df.cols.append()
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
             ...
             ('Tiemstamp', TimestampType(), True), ('Cybertronian', BooleanType(), True),
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True),
             ('new_col_4', StringType(), False), ('new_col_5', IntegerType(), True),
             ('new_col_6', ArrayType(IntegerType(), False), False)], [("Optim'us", 28, 'Leader', 10, 5000000,
                                                                       4.300000190734863, '[Inochi, Convoy]',
                                                                       '19.442735,-99.201111', '1980/04/10',
                                                                       '2016/09/10', [8.53439998626709, 4300.0],
                                                                       datetime.date(2016, 9, 10),
                                                                       datetime.datetime(2014, 6, 24, 0, 0), True,
                                                                       bytearray(b'Leader'), None, 'test', 20,
                                                                       [1, 2, 3]), (
                                                                      'bumbl#ebéé  ', 17, 'Espionage', 7, 5000000, 2.0,
                                                                      '[Bumble, Goldback]', '10.642707,-71.612534',
                                                                      '1980/04/10', '2015/08/10',
                                                                      ...
                                                                      datetime.date(2015, 8, 10),
                                                                      datetime.datetime(2014, 6, 24, 0, 0), True,
                                                                      bytearray(b'Espionage'), None, 'test', 14,
                                                                      [1, 2, 3]), (
                                                                      'ironhide&', 26, 'Security', 7, 5000000, 4.0,
                                                                      '[Roadbuster]', '37.789563,-122.400356',
                                                                      '1980/04/10', '2014/07/10',
                                                                      ...
                                                                      datetime.date(2014, 6, 24),
                                                                      datetime.datetime(2014, 6, 24, 0, 0), True,
                                                                      bytearray(b'Security'), None, 'test', 14,
                                                                      [1, 2, 3]), (
                                                                      'Jazz', 13, 'First Lieutenant', 8, 5000000,
                                                                      1.7999999523162842, '[Meister]',
                                                                      '33.670666,-117.841553', '1980/04/10',
                                                                      ...
                                                                      datetime.date(2013, 6, 24),
                                                                      datetime.datetime(2014, 6, 24, 0, 0), True,
                                                                      bytearray(b'First Lieutenant'), None, 'test', 16,
                                                                      [1, 2, 3]), (
                                                                      'Megatron', None, 'None', 10, 5000000,
                                                                      5.699999809265137, '[Megatron]', None,
                                                                      '1980/04/10', '2012/05/10', [None, 5700.0],
                                                                      datetime.date(2012, 5, 10),
                                                                      datetime.datetime(2014, 6, 24, 0, 0), True,
                                                                      bytearray(b'None'), None, 'test', 20, [1, 2, 3]),
                                                                      ('Metroplex_)^$', 300, 'Battle Station', 8,
                                                                       5000000, None, '[Metroflex]', None, '1980/04/10',
                                                                       '2011/04/10', [91.44000244140625, None],
                                                                       datetime.date(2011, 4, 10),
                                                                       datetime.datetime(2014, 6, 24, 0, 0), True,
                                                                       bytearray(b'Battle Station'), None, 'test', 16,
                                                                       [1, 2, 3])])
        assert (expected_df.collect() == actual_df.collect())
    ...
    def test_cols_drop():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('age', IntegerType(), True), ('weight(t)', FloatType(), True), ('japanese name', StringType(), True),
             ('last position seen', StringType(), True), ('date arrival', StringType(), True),
             ('last date seen', StringType(), True), ('attributes', ArrayType(FloatType(), True), True),
             ...
             ('NullType', NullType(), True)], [(
                                               "Optim'us", 28, 'Leader', 5000000, 4.300000190734863, '[Inochi, Convoy]',
                                               '19.442735,-99.201111', '1980/04/10', '2016/09/10',
                                               ...
                                               ('bumbl#ebéé  ', 17, 'Espionage', 5000000, 2.0, '[Bumble, Goldback]',
                                                ...
                                                [5.334000110626221, 2000.0], datetime.date(2015, 8, 10),
                                                datetime.datetime(2014, 6, 24, 0, 0), True, bytearray(b'Espionage'),
                                               ...
                                               '1980/04/10', '2012/05/10', [None, 5700.0], datetime.date(2012, 5, 10),
                                               datetime.datetime(2014, 6, 24, 0, 0), True, bytearray(b'None'), None), (
                                               'Metroplex_)^$', 300, 'Battle Station', 5000000, None, '[Metroflex]',
                                               None, '1980/04/10', '2011/04/10', [91.44000244140625, None],
    ...
    def test_cols_cast_vector():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ...
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
             ('date arrival', StringType(), True), ('last date seen', StringType(), True),
             ('attributes', VectorUDT(), True), ('DateType', DateType(), True), ('Tiemstamp', TimestampType(), True),
             ('Cybertronian', BooleanType(), True), ('function(binary)', BinaryType(), True),
             ('NullType', NullType(), True)], [("Optim'us", 28, 'Leader', 10, 5000000, 4.300000190734863,
                                                ...
                                                DenseVector([8.5344, 4300.0]), datetime.date(2016, 9, 10),
                                                datetime.datetime(2014, 6, 24, 0, 0), True, bytearray(b'Leader'), None),
    ...
    def test_cols_move():
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ...
             ('last position seen', StringType(), True), ('date arrival', StringType(), True),
             ('last date seen', StringType(), True), ('attributes', ArrayType(FloatType(), True), True),
             ('rank', ByteType(), True), ('DateType', DateType(), True), ('Tiemstamp', TimestampType(), True),
             ('Cybertronian', BooleanType(), True), ('function(binary)', BinaryType(), True),
             ('NullType', NullType(), True)], [(
                                               "Optim'us", 28, 'Leader', 5000000, 4.300000190734863, '[Inochi, Convoy]',
                                               '19.442735,-99.201111', '1980/04/10', '2016/09/10',
                                               [8.53439998626709, 4300.0], 10, datetime.date(2016, 9, 10),
                                               datetime.datetime(2014, 6, 24, 0, 0), True, bytearray(b'Leader'), None),
                                               ('bumbl#ebéé  ', 17, 'Espionage', 5000000, 2.0, '[Bumble, Goldback]',
                                                '10.642707,-71.612534', '1980/04/10', '2015/08/10',
    ...
    def test_cols_select():
        actual_df = source_df.cols.select('height(ft)')
    ...
    def test_cols_sort():
        ...
        expected_df = op.create.df(
            [('Cybertronian', BooleanType(), True), ('DateType', DateType(), True), ('NullType', NullType(), True),
             ...
             ('height(ft)', ShortType(), True), ('japanese name', StringType(), True),
    ...
    def test_cols_sort_desc():
        ...
        expected_df = op.create.df(
            [('weight(t)', FloatType(), True), ('rank', ByteType(), True), ('names', StringType(), True),
             ...
             ('japanese name', StringType(), True), ('height(ft)', ShortType(), True),
             ...
             ('DateType', DateType(), True), ('Cybertronian', BooleanType(), True)], [(
                                                                                      ...
                                                                                      '19.442735,-99.201111',
                                                                                      '2016/09/10', '[Inochi, Convoy]',
                                                                                      28, bytearray(b'Leader'),
                                                                                      'Leader', '1980/04/10',
                                                                                      [8.53439998626709, 4300.0],
                                                                                      5000000,
    ...
    @staticmethod
    def test_cols_nest():
        actual_df = source_df.cols.nest('new col', separator=' ')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    @staticmethod
    def test_cols_nest_mix():
        actual_df = source_df.cols.nest('E', separator='--')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
             ...
             ('attributes', ArrayType(FloatType(), True), True), ('DateType', DateType(), True),
             ('Tiemstamp', TimestampType(), True), ('Cybertronian', BooleanType(), True),
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True), ('E', StringType(), False)], [(
                                                                                                                     "Optim'us",
                                                                                                                     28,
                                                                                                                     'Leader',
                                                                                                                     10,
    ...
    def test_cols_nest_vector():
        actual_df = source_df.cols.nest('new col', shape='vector')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
    ...
    def test_cols_nest_array():
        actual_df = source_df.cols.nest('new col', shape='array')
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', ShortType(), True), ('function', StringType(), True),
             ('rank', ByteType(), True), ('age', IntegerType(), True), ('weight(t)', FloatType(), True),
             ('japanese name', StringType(), True), ('last position seen', StringType(), True),
        ...
        expected_df = op.create.df(
            [('names', StringType(), True), ('height(ft)', BooleanType(), False), ('function', StringType(), True),
             ...
             ('function(binary)', BinaryType(), True), ('NullType', NullType(), True)], [("Optim'us", False, 'Leader',
                                                                                          ...
                                                                                          bytearray(b'Leader'), None), (
                                                                                         'bumbl#ebéé  ', False,
                                                                                         'Espionage', False, False,
                                                                                         False, '[Bumble, Goldback]',
                                                                                         '10.642707,-71.612534',
                                                                                         '1980/04/10', '2015/08/10',
                                                                                         [5.334000110626221, 2000.0],
                                                                                         datetime.date(2015, 8, 10),
