...
class TestMaskPandas(TestBase):
 ...
 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
    ...
    def test_mask_datetime(self):
        ...
        expected = self.create_dataframe(data={('datetime_test', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_datetime_multiple(self):
        ...
        expected = self.create_dataframe(data={('Date Type', 'bool'): [False, False, False, False, False, False], ('last date seen', 'bool'): [False, False, False, False, False, False], ('timestamp', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_expression_all_colname(self):
        ...
        expected = self.create_dataframe(data={('last position seen', 'object'): ['19.442735,-99.201111', '10.642707,-71.612534', '37.789563,-122.400356', '33.670666,-117.841553', None, None]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_expression_multiple_colname(self):
        ...
        expected = self.create_dataframe(data={('NullType', 'object'): [None, None, None, None, None, None]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
