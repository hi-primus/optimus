...
class TestMaskPandas(TestBase):
    ...
    def test_mask_all_all(self):
        ...
        expected = self.create_dataframe(dict={('NullType_Code_Multiple_attributes_date '
 ...
 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
    ...
    def test_mask_all_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType_weight(t)_japanese name', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_all_string(self):
        ...
        expected = self.create_dataframe(dict={('names', 'object'): ['Optimus', 'bumbl#ebéé  ', 'ironhide&', 'Jazz', 'Megatron', 'Metroplex_)^$']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
 ...
 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
    ...
    def test_mask_any_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType_weight(t)_japanese name', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_array(self):
        ...
        expected = self.create_dataframe(dict={('array_test', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_between_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'bool'): [False, True, False, True, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_boolean(self):
        ...
        expected = self.create_dataframe(dict={('boolean_test', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_boolean_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [False, False, False, False, False, False], ('weight(t)', 'bool'): [False, False, False, False, False, False], ('Cybertronian', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_contains_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [True, True, True, True, True, True], ('weight(t)', 'bool'): [False, False, False, False, False, False], ('Cybertronian', 'bool'): [True, True, True, True, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_contains_numeric(self):
        df = self.df
        result = df.mask.contains(cols=['height(ft)'], value='0', flags=0, na=True, regex=False)
        expected = self.create_dataframe(dict={('height(ft)', 'bool'): [True, True, True, True, False, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_contains_string(self):
        df = self.df
        result = df.mask.contains(cols=['function'], value='Le.', case=True, flags=3, na=False, regex=True)
        expected = self.create_dataframe(dict={('function', 'bool'): [True, False, False, False, False, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_credit_card_number(self):
        ...
        expected = self.create_dataframe(dict={('credit_card_number_test', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_datetime(self):
        ...
        expected = self.create_dataframe(dict={('datetime_test', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_datetime_multiple(self):
        ...
        expected = self.create_dataframe(dict={('Date Type', 'bool'): [False, False, False, False, False, False], ('last date seen', 'bool'): [False, False, False, False, False, False], ('timestamp', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_duplicated_multiple(self):
        ...
        expected = self.create_dataframe(dict={('__duplicated__', 'bool'): [False, True, True, True, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_duplicated_numeric(self):
        ...
        expected = self.create_dataframe(dict={('rank', 'bool'): [False, False, True, False, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_duplicated_numeric_last(self):
        ...
        expected = self.create_dataframe(dict={('rank', 'bool'): [True, True, False, True, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_email(self):
        ...
        expected = self.create_dataframe(dict={('email_test', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_ends_with_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [True, True, True, True, True, True], ('weight(t)', 'bool'): [False, False, False, False, False, False], ('Cybertronian', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_ends_with_string(self):
        ...
        expected = self.create_dataframe(dict={('function', 'bool'): [False, True, False, False, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_equal_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [False, False, False, False, False, False], ('weight(t)', 'bool'): [False, False, False, False, False, False], ('Cybertronian', 'bool'): [True, True, True, True, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_equal_numeric(self):
        df = self.df
        result = df.mask.equal(cols=['height(ft)'], value=300)
        expected = self.create_dataframe(dict={('height(ft)', 'bool'): [False, False, False, False, False, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_find_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'bool'): [False, False, False, True, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_float_all(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [False, False, False, False, False, False], ('Code', 'bool'): [False, True, False, False, False, False], ('Multiple', 'bool'): [False, False, False, True, False, False], ('attributes', 'bool'): [False, False, False, False, False, False], ('date arrival', 'bool'): [False, False, False, False, False, False], ('function(binary)', 'bool'): [False, False, False, False, False, False], ('height(ft)', 'bool'): [True, True, True, True, True, True], ('japanese name', 'bool'): [False, False, False, False, False, False], ('last date seen', 'bool'): [False, False, False, False, False, False], ('last position seen', 'bool'): [False, False, False, False, False, False], ('rank', 'bool'): [False, False, False, False, False, False], ('Cybertronian', 'bool'): [False, False, False, False, False, False], ('Date Type', 'bool'): [False, False, False, False, False, False], ('age', 'bool'): [False, False, False, False, False, False], ('function', 'bool'): [False, False, False, False, False, False], ('names', 'bool'): [False, False, False, False, False, False], ('timestamp', 'bool'): [False, False, False, False, False, False], ('weight(t)', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_float_multiple(self):
        df = self.df
        result = df.mask.float(cols=['NullType', 'weight(t)', 'japanese name'])
        expected = self.create_dataframe(dict={('NullType', 'bool'): [False, False, False, False, False, False], ('weight(t)', 'bool'): [True, True, True, True, True, True], ('japanese name', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_gender(self):
        ...
        expected = self.create_dataframe(dict={('gender_test', 'bool'): [True, True, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_greater_than_equal_multiple(self):
        ...
        expected = self.create_dataframe(dict={('age', 'bool'): [True, True, True, True, True, True], ('NullType', 'bool'): [False, False, False, False, False, False], ('weight(t)', 'bool'): [True, True, True, True, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_http_code(self):
        ...
        expected = self.create_dataframe(dict={('http_code_test', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_int_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [False, False, False, False, False, False], ('weight(t)', 'bool'): [False, True, True, False, False, False], ('japanese name', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_ip(self):
        ...
        expected = self.create_dataframe(dict={('ip_test', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_less_than_equal_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'bool'): [True, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_nan_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [False, False, False, False, False, False], ('weight(t)', 'bool'): [False, False, False, False, False, True], ('japanese name', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_none_multiple(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [True, True, True, True, True, True], ('weight(t)', 'bool'): [False, False, False, False, False, False], ('japanese name', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_not_equal_all(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'bool'): [True, True, True, True, True, True], ('Code', 'bool'): [True, True, True, True, True, True], ('Multiple', 'bool'): [True, True, True, True, True, True], ('attributes', 'bool'): [True, True, True, True, True, True], ('date arrival', 'bool'): [True, True, True, True, True, True], ('function(binary)', 'bool'): [True, True, True, True, True, True], ('height(ft)', 'bool'): [True, True, True, True, True, True], ('japanese name', 'bool'): [True, True, True, True, True, True], ('last date seen', 'bool'): [True, True, True, True, True, True], ('last position seen', 'bool'): [True, True, True, True, True, True], ('rank', 'bool'): [False, True, True, True, False, True], ('Cybertronian', 'bool'): [True, True, True, True, True, True], ('Date Type', 'bool'): [True, True, True, True, True, True], ('age', 'bool'): [True, True, True, True, True, True], ('function', 'bool'): [True, True, True, True, True, True], ('names', 'bool'): [True, True, True, True, True, True], ('timestamp', 'bool'): [True, True, True, True, True, True], ('weight(t)', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_not_equal_multiple(self):
        df = self.df
        result = df.mask.not_equal(cols=['NullType', 'weight(t)', 'Cybertronian'], value=True)
        expected = self.create_dataframe(dict={('NullType', 'bool'): [True, True, True, True, True, True], ('weight(t)', 'bool'): [True, True, True, True, True, True], ('Cybertronian', 'bool'): [False, False, False, False, False, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_not_equal_numeric(self):
        df = self.df
        result = df.mask.not_equal(cols=['height(ft)'], value=300)
        expected = self.create_dataframe(dict={('height(ft)', 'bool'): [True, True, True, True, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_not_equal_string(self):
        df = self.df
        result = df.mask.not_equal(cols=['function'], value='Leader')
        expected = self.create_dataframe(dict={('function', 'bool'): [False, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_null_all(self):
        df = self.df
        result = df.mask.null(cols='*', how='all')
        expected = self.create_dataframe(dict={('__null__', 'bool'): [False, False, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_object(self):
        ...
        expected = self.create_dataframe(dict={('object_test', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_object_all(self):
        df = self.df
        result = df.mask.object(cols='*')
        expected = self.create_dataframe(dict={('NullType', 'bool'): [True, True, True, True, True, True], ('Code', 'bool'): [True, True, True, True, True, True], ('Multiple', 'bool'): [True, True, True, True, True, True], ('attributes', 'bool'): [True, True, True, True, True, True], ('date arrival', 'bool'): [True, True, True, True, True, True], ('function(binary)', 'bool'): [True, True, True, True, True, True], ('height(ft)', 'bool'): [True, True, True, True, True, True], ('japanese name', 'bool'): [True, True, True, True, True, True], ('last date seen', 'bool'): [True, True, True, True, True, True], ('last position seen', 'bool'): [True, True, True, True, True, True], ('rank', 'bool'): [True, True, True, True, True, True], ('Cybertronian', 'bool'): [True, True, True, True, True, True], ('Date Type', 'bool'): [True, True, True, True, True, True], ('age', 'bool'): [True, True, True, True, True, True], ('function', 'bool'): [True, True, True, True, True, True], ('names', 'bool'): [True, True, True, True, True, True], ('timestamp', 'bool'): [True, True, True, True, True, True], ('weight(t)', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_mask_object_multiple(self):
        df = self.df
        result = df.mask.object(cols=['NullType', 'weight(t)', 'japanese name'])
        expected = self.create_dataframe(dict={('NullType', 'bool'): [True, True, True, True, True, True], ('weight(t)', 'bool'): [True, True, True, True, True, True], ('japanese name', 'bool'): [True, True, True, True, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_phone_number(self):
        ...
        expected = self.create_dataframe(dict={('phone_number_test', 'bool'): [True, False, False, False, True, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_social_security_number(self):
        ...
        expected = self.create_dataframe(dict={('social_security_number_test', 'bool'): [False, True, False, False, False, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_unique_multiple(self):
        ...
        expected = self.create_dataframe(dict={('__duplicated__', 'bool'): [True, False, False, False, False, True]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_mask_zip_code(self):
        ...
        expected = self.create_dataframe(dict={('zip_code_test', 'bool'): [True, True, True, True, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
