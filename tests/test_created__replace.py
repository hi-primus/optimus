...
class TestReplacePandas(TestBase):
    ...
    def test_cols_replace_list_value_chars(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['MATCH', 'Espionage', 'MATCHrity', 'MATCHt Lieutenant', 'MATCH', 'Battle Station']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_list_value_full(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['MATCH', 'Espionage', 'Security', 'First Lieutenant', 'MATCH', 'Battle Station']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_lists_list_chars(self):
        df = self.df.cols.select(['function', 'japanese name'])
        result = df.cols.replace(cols=['function', 'japanese name'], search_by='chars', search=['atro', 'nochi'], replace_by=['Inochi', 'Megatron'])
        expected = self.create_dataframe(dict={('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('japanese name', 'object'): ["['IMegatron', 'Convoy']", "['Bumble', 'Goldback']", "['Roadbuster']", "['Meister']", "['MegInochin']", "['Metroflex']"]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))

    def test_cols_replace_lists_list_full(self):
        df = self.df.cols.select(['function', 'Code', 'Cybertronian'])
        result = df.cols.replace(cols=['function', 'Code', 'Cybertronian'], search_by='full', search=['123', '456', '123A'], replace_by=['N/A', 'Number', 'String'])
        expected = self.create_dataframe(dict={('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('Code', 'object'): ['String', 'Number', 456, 'e', None, '{code}'], ('Cybertronian', 'object'): ['False', 'True + 1', 1, None, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_lists_list_values(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('japanese name', 'object'): [['Inochi', 'Convoy'], ['Bumble', 'Goldback'], ['Roadbuster'], ['Meister'], ['Megatron'], ['Metroflex']]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_lists_list_words(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('japanese name', 'object'): ["['other-match', 'Convoy']", "['Bumble', 'Goldback']", "['Roadbuster']", "['Meister']", "['a-match']", "['Metroflex']"]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_list_list_chars(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['4cer', '5c', '4c4c', '5cc4c', '4c', '5ccon']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_list_list_full(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['6c', 'Espionage', 'Security', 'First Lieutenant', '4c', 'Battle Station']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_list_list_words(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['6c', 'Espionage', 'Security', '5c Lieutenant', '4c', '6c Station']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_list_value_chars(self):
        ...
        expected = self.create_dataframe(dict={('names', 'object'): ['starts with a vowelptimus', 'bumbl#ebéé  ', 'starts with a vowelronhide&', 'Jazz', 'Megatron', 'Metroplex_)^$']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_lists_list_full(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('Code', 'object'): ['123A', '456', 456, 'is a number', None, '{code}'], ('Cybertronian', 'object'): ['False', 'True + 1', 1, None, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_lists_list_values(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('Code', 'object'): ['123A', '456', 456, 'is boolean', None, '{code}'], ('Cybertronian', 'object'): ['False', 'True + 1', 1, None, True, False]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_lists_list_words(self):
        ...
        expected = self.create_dataframe(dict={('function', 'object'): ['Leader', 'Espionage', 'Security', 'Firstis booleanLieutenant', 'None', 'Battleis booleanStation'], ('Code', 'object'): ['123A', '456', '456', 'is boolean', 'None', '{code}'], ('Cybertronian', 'object'): ['False', 'True + 1', '1', 'None', 'True', 'False']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_replace_regex_value_chars(self):
        ...
        expected = self.create_dataframe(dict={('names', 'object'): ['Optimus', 'bumbl#ebéé  ', 'ironhide&', 'Jazz', 'must be Megatron', 'Metroplex_)^$']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
