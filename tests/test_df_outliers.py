...
class Testdf_outliers(object):
	...
	def test_outliers_mad_count():
		actual_df =source_df.outliers.mad('height(ft)',0.5,0)
	...
	def test_outliers_modified_z_score_count():
		actual_df =source_df.outliers.modified_z_score('height(ft)',0.5,0)
		actual_df =json_enconding(actual_df)
		expected_value =json_enconding(3)
		assert (expected_value == actual_df)
	@staticmethod
	...
	def test_outliers_tukey_count():
		actual_df =source_df.outliers.tukey('height(ft)')
		actual_df =json_enconding(actual_df)
	...
	def test_outliers_z_score_count():
		actual_df =source_df.outliers.z_score('height(ft)',0.5)
		actual_df =json_enconding(actual_df)
		expected_value =json_enconding(2)
		assert (expected_value == actual_df)
	@staticmethod
