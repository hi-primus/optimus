...
class TestStringPandas(TestBase):
    ...
    def test_cols_capitalize(self):
        df = self.create_dataframe(dict={('capitalize_test', 'object'): ['ThIs iS A TEST', 'ThIs', 'iS', 'a ', ' TEST', 'this is a test']}, force_data_types=True)
        result = df.cols.capitalize(cols=['capitalize_test'])
        expected = self.create_dataframe(dict={('capitalize_test', 'object'): ['This is a test', 'This', 'Is', 'A ', ' test', 'This is a test']}, force_data_types=True)
    ...
    def test_cols_len(self):
        df = self.create_dataframe(dict={('len_test', 'object'): ['      ', '12', '', ' how many characters are in this sentence?', '!@#$%^&*()_>?:}', ' 1     2      3   ']}, force_data_types=True)
        result = df.cols.len(cols=['len_test'])
        expected = self.create_dataframe(dict={('len_test', 'int64'): [6, 2, 0, 42, 15, 18]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_len_all(self):
        df = self.df
        result = df.cols.len(cols='*')
        expected = self.create_dataframe(dict={('NullType', 'object'): [None, None, None, None, None, None], ('attributes', 'int64'): [2, 2, 2, 2, 2, 2], ('date arrival', 'int64'): [10, 10, 10, 10, 10, 10], ('function(binary)', 'int64'): [6, 9, 8, 16, 4, 14], ('height(ft)', 'int64'): [5, 4, 4, 4, 3, 5], ('japanese name', 'int64'): [2, 2, 1, 1, 1, 1], ('last date seen', 'int64'): [10, 10, 10, 10, 10, 10], ('last position seen', 'float64'): [20.0, 20.0, 21.0, 21.0, nan, nan], ('rank', 'int64'): [2, 1, 1, 1, 2, 1], ('Cybertronian', 'int64'): [4, 4, 4, 4, 4, 5], ('Date Type', 'int64'): [10, 10, 10, 10, 10, 10], ('age', 'int64'): [7, 7, 7, 7, 7, 7], ('function', 'int64'): [6, 9, 8, 16, 4, 14], ('names', 'int64'): [7, 12, 9, 4, 8, 13], ('timestamp', 'int64'): [10, 10, 10, 10, 10, 10], ('weight(t)', 'int64'): [3, 3, 3, 3, 3, 3]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_len_multiple(self):
        df = self.df
        result = df.cols.len(cols=['NullType', 'weight(t)', 'japanese name'],output_cols=['nt', 'wt', 'jn'])
        expected = self.create_dataframe(dict={('NullType', 'object'): [None, None, None, None, None, None], ('nt', 'object'): [None, None, None, None, None, None], ('attributes', 'object'): [[8.5344, 4300.0], [5.334, 2000.0], [7.9248, 4000.0], [3.9624, 1800.0], [None, 5700.0], [91.44, None]], ('date arrival', 'object'): ['1980/04/10', '1980/04/10', '1980/04/10', '1980/04/10', '1980/04/10', '1980/04/10'], ('function(binary)', 'object'): [bytearray(b'Leader'), bytearray(b'Espionage'), bytearray(b'Security'), bytearray(b'First Lieutenant'), bytearray(b'None'), bytearray(b'Battle Station')], ('height(ft)', 'float64'): [-28.0, 17.0, 26.0, 13.0, nan, 300.0], ('japanese name', 'object'): [['Inochi', 'Convoy'], ['Bumble', 'Goldback'], ['Roadbuster'], ['Meister'], ['Megatron'], ['Metroflex']], ('jn', 'int64'): [2, 2, 1, 1, 1, 1], ('last date seen', 'object'): ['2016/09/10', '2015/08/10', '2014/07/10', '2013/06/10', '2012/05/10', '2011/04/10'], ('last position seen', 'object'): ['19.442735,-99.201111', '10.642707,-71.612534', '37.789563,-122.400356', '33.670666,-117.841553', None, None], ('rank', 'int64'): [10, 7, 7, 8, 10, 8], ('Cybertronian', 'bool'): [True, True, True, True, True, False], ('Date Type', 'datetime64[ns]'): [Timestamp('2016-09-10 00:00:00'), Timestamp('2015-08-10 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2013-06-24 00:00:00'), Timestamp('2012-05-10 00:00:00'), Timestamp('2011-04-10 00:00:00')], ('age', 'int64'): [5000000, 5000000, 5000000, 5000000, 5000000, 5000000], ('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('names', 'object'): ['Optimus', 'bumbl#ebéé  ', 'ironhide&', 'Jazz', 'Megatron', 'Metroplex_)^$'], ('timestamp', 'datetime64[ns]'): [Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00')], ('weight(t)', 'float64'): [4.3, 2.0, 4.0, 1.8, 5.7, nan], ('wt', 'int64'): [3, 3, 3, 3, 3, 3]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_len_numeric(self):
        df = self.df.cols.select(['height(ft)'])
        result = df.cols.len(cols=['height(ft)'])
        expected = self.create_dataframe(dict={('height(ft)', 'int64'): [5, 4, 4, 4, 3, 5]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_len_string(self):
        df = self.df.cols.select(['names'])
        result = df.cols.len(cols=['names'],output_cols=['names_2'])
        expected = self.create_dataframe(dict={('names', 'object'): ['Optimus', 'bumbl#ebéé  ', 'ironhide&', 'Jazz', 'Megatron', 'Metroplex_)^$'], ('names_2', 'int64'): [7, 12, 9, 4, 8, 13]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_lower(self):
        df = self.create_dataframe(dict={('lower_test', 'object'): ['ThIs iS A TEST', 'ThIs', 'iS', 'a ', ' TEST', 'this is a test']}, force_data_types=True)
        result = df.cols.lower(cols=['lower_test'])
        expected = self.create_dataframe(dict={('lower_test', 'object'): ['this is a test', 'this', 'is', 'a ', ' test', 'this is a test']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_normalize_spaces(self):
        df = self.create_dataframe(dict={('normalize_spaces_test', 'object'): ['more       close', '      for  ', 'h   o    w', 'many  words  are in this   sentence', '      ', 'WhatIfThereAreNoSpaces']}, force_data_types=True)
        result = df.cols.normalize_spaces(cols=['normalize_spaces_test'])
        expected = self.create_dataframe(dict={('normalize_spaces_test', 'object'): ['more close', ' for ', 'h o w', 'many words are in this sentence', ' ', 'WhatIfThereAreNoSpaces']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_remove_numbers_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'object'): ['-.', '.', '.', '.', 'nan', '.']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_remove_special_chars(self):
        df = self.create_dataframe(dict={('remove_special_chars_test', 'object'): ['2 plus 2 equals 4', 'bumbl#ebéé   is about 5000000 years old', "these aren't special characters: `~!@#$%^&*()?/\\|", 'why is pi=3.141592... an irrational number?', '3^3=27', "don't @ me"]}, force_data_types=True)
        result = df.cols.remove_special_chars(cols=['remove_special_chars_test'])
        expected = self.create_dataframe(dict={('remove_special_chars_test', 'object'): ['2 plus 2 equals 4', 'bumblebéé   is about 5000000 years old', 'these arent special characters ', 'why is pi3141592 an irrational number', '3327', 'dont  me']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_remove_special_chars_all(self):
        df = self.df
        result = df.cols.remove_special_chars(cols='*')
        expected = self.create_dataframe(dict={('NullType', 'object'): ['None', 'None', 'None', 'None', 'None', 'None'], ('attributes', 'object'): ['85344 43000', '5334 20000', '79248 40000', '39624 18000', 'None 57000', '9144 None'], ('date arrival', 'object'): ['19800410', '19800410', '19800410', '19800410', '19800410', '19800410'], ('function(binary)', 'object'): ['bytearraybLeader', 'bytearraybEspionage', 'bytearraybSecurity', 'bytearraybFirst Lieutenant', 'bytearraybNone', 'bytearraybBattle Station'], ('height(ft)', 'object'): ['280', '170', '260', '130', 'nan', '3000'], ('japanese name', 'object'): ['Inochi Convoy', 'Bumble Goldback', 'Roadbuster', 'Meister', 'Megatron', 'Metroflex'], ('last date seen', 'object'): ['20160910', '20150810', '20140710', '20130610', '20120510', '20110410'], ('last position seen', 'object'): ['1944273599201111', '1064270771612534', '37789563122400356', '33670666117841553', 'None', 'None'], ('rank', 'object'): ['10', '7', '7', '8', '10', '8'], ('Cybertronian', 'object'): ['True', 'True', 'True', 'True', 'True', 'False'], ('Date Type', 'object'): ['20160910', '20150810', '20140624', '20130624', '20120510', '20110410'], ('age', 'object'): ['5000000', '5000000', '5000000', '5000000', '5000000', '5000000'], ('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('names', 'object'): ['Optimus', 'bumblebéé  ', 'ironhide', 'Jazz', 'Megatron', 'Metroplex'], ('timestamp', 'object'): ['20140624', '20140624', '20140624', '20140624', '20140624', '20140624'], ('weight(t)', 'object'): ['43', '20', '40', '18', '57', 'nan']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_remove_special_chars_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'object'): ['280', '170', '260', '130', 'nan', '3000']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_remove_special_chars_string(self):
        df = self.df.cols.select(['names'])
        result = df.cols.remove_special_chars(cols=['names'],output_cols=['names_2'])
        expected = self.create_dataframe(dict={('names', 'object'): ['Optimus', 'bumbl#ebéé  ', 'ironhide&', 'Jazz', 'Megatron', 'Metroplex_)^$'], ('names_2', 'object'): ['Optimus', 'bumblebéé  ', 'ironhide', 'Jazz', 'Megatron', 'Metroplex']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_remove_white_spaces(self):
        df = self.create_dataframe(dict={('remove_white_spaces_test', 'object'): ['i   n te  rest i ng ', 'This I s A Test', '     ', 'ThisOneHasNoWhiteSpaces', 'Th is One  Sho   uld Be    AllTogether   ', "L et  ' s G oo o o  o    o"]}, force_data_types=True)
        result = df.cols.remove_white_spaces(cols=['remove_white_spaces_test'])
        expected = self.create_dataframe(dict={('remove_white_spaces_test', 'object'): ['interesting', 'ThisIsATest', '', 'ThisOneHasNoWhiteSpaces', 'ThisOneShouldBeAllTogether', "Let'sGoooooo"]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_title(self):
        ...
        expected = self.create_dataframe(dict={('title_test', 'object'): ['This Is A Test', 'This', 'Is', 'A ', ' Test', 'This Is A Test']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_trim(self):
        df = self.create_dataframe(dict={('trim_test', 'object'): ['ThIs iS A TEST', 'foo', '     bar', 'baz      ', '      zoo     ', '   t e   s   t   ']}, force_data_types=True)
        result = df.cols.trim(cols=['trim_test'])
        expected = self.create_dataframe(dict={('trim_test', 'object'): ['ThIs iS A TEST', 'foo', 'bar', 'baz', 'zoo', 't e   s   t']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    
    def test_cols_trim_all(self):
        df = self.df
        result = df.cols.trim(cols='*')
        expected = self.create_dataframe(dict={('NullType', 'object'): [None, None, None, None, None, None], ('attributes', 'float64'): [nan, nan, nan, nan, nan, nan], ('date arrival', 'object'): ['1980/04/10', '1980/04/10', '1980/04/10', '1980/04/10', '1980/04/10', '1980/04/10'], ('function(binary)', 'object'): [bytearray(b'Leader'), bytearray(b'Espionage'), bytearray(b'Security'), bytearray(b'First Lieutenant'), bytearray(b'None'), bytearray(b'Battle Station')], ('height(ft)', 'object'): ['-28.0', '17.0', '26.0', '13.0', 'nan', '300.0'], ('japanese name', 'float64'): [nan, nan, nan, nan, nan, nan], ('last date seen', 'object'): ['2016/09/10', '2015/08/10', '2014/07/10', '2013/06/10', '2012/05/10', '2011/04/10'], ('last position seen', 'object'): ['19.442735,-99.201111', '10.642707,-71.612534', '37.789563,-122.400356', '33.670666,-117.841553', None, None], ('rank', 'object'): ['10', '7', '7', '8', '10', '8'], ('Cybertronian', 'object'): ['True', 'True', 'True', 'True', 'True', 'False'], ('Date Type', 'object'): ['2016-09-10', '2015-08-10', '2014-06-24', '2013-06-24', '2012-05-10', '2011-04-10'], ('age', 'object'): ['5000000', '5000000', '5000000', '5000000', '5000000', '5000000'], ('function', 'object'): ['Leader', 'Espionage', 'Security', 'First Lieutenant', 'None', 'Battle Station'], ('names', 'object'): ['Optimus', 'bumbl#ebéé', 'ironhide&', 'Jazz', 'Megatron', 'Metroplex_)^$'], ('timestamp', 'object'): ['2014-06-24', '2014-06-24', '2014-06-24', '2014-06-24', '2014-06-24', '2014-06-24'], ('weight(t)', 'object'): ['4.3', '2.0', '4.0', '1.8', '5.7', 'nan']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_upper(self):
        df = self.create_dataframe(dict={('upper_test', 'object'): ['ThIs iS A TEST', 'ThIs', 'iS', 'a ', ' TEST', 'this is a test']}, force_data_types=True)
        result = df.cols.upper(cols=['upper_test'])
        expected = self.create_dataframe(dict={('upper_test', 'object'): ['THIS IS A TEST', 'THIS', 'IS', 'A ', ' TEST', 'THIS IS A TEST']}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
