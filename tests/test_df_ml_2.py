...
class Testdf_ml_2(object):
	...
	def test_normalizer():
		...
		expected_df = op.create.df([('id', LongType(), True),('x', LongType(), True),('y', LongType(), True),('features', VectorUDT(), True),('features***NORMALIZER', VectorUDT(), True)], [(0, 1, 2, DenseVector([1.0, 0.5, -1.0]), DenseVector([0.6667, 0.3333, -0.6667])), (1, 2, 3, DenseVector([2.0, 1.0, 1.0]), DenseVector([0.8165, 0.4082, 0.4082])), (2, 3, 4, DenseVector([4.0, 10.0, 2.0]), DenseVector([0.3651, 0.9129, 0.1826]))])
