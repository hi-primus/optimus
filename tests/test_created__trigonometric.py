...
class TestTrigonometricPandas(TestBase):
 ...
 'wt': [-0.40079917207997545, -0.4161468365471424, -0.6536436208636119, -0.2272020946930871, 0.8347127848391598, nan]}
 ...
 'timestamp': [Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00')],
 'weight(t)': [4.3, 2.0, 4.0, 1.8, 5.7, nan],
 'wt': [0.9996318561900731, 0.9640275800758169, 0.999329299739067, 0.9468060128462683, 0.9999776092809898, nan]}
        self.assertEqual(json_encoding(result), json_encoding(expected))
 ...
 'timestamp': [Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00')],
 'weight(t)': [4.3, 2.0, 4.0, 1.8, 5.7, nan],
 'wt': [2.1650167641453284, 1.4436354751788103, 2.0947125472611012, 1.3504407402749725, 2.44122070725561, nan]}
        self.assertEqual(json_encoding(result), json_encoding(expected))
    ...
    def test_cols_acosh(self):
        ...
        expected = self.create_dataframe(dict={('acosh_test', 'float64'): [nan, nan, 0.0, nan, nan, 7.393877911874976]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    
    def test_cols_acos(self):
        df = self.create_dataframe(dict={('acos_test', 'object'): [1, '0', 9, nan, -inf, None]}, force_data_types=True)
    ...
    def test_cols_tan_all(self):
        ...
        expected = self.create_dataframe(dict={('NullType', 'float64'): [nan, nan, nan, nan, nan, nan], ('attributes', 'float64'): [nan, nan, nan, nan, nan, nan], ('date arrival', 'float64'): [nan, nan, nan, nan, nan, nan], ('function(binary)', 'float64'): [nan, nan, nan, nan, nan, nan], ('height(ft)', 'float64'): [0.28142960456426525, 3.4939156454748397, 1.17875355420628, 0.4630211329364896, nan, 45.244742070819356], ('japanese name', 'float64'): [nan, nan, nan, nan, nan, nan], ('last date seen', 'float64'): [nan, nan, nan, nan, nan, nan], ('last position seen', 'float64'): [nan, nan, nan, nan, nan, nan], ('rank', 'float64'): [0.6483608274590867, 0.8714479827243188, 0.8714479827243188, -6.799711455220378, 0.6483608274590867, -6.799711455220378], ('Cybertronian', 'float64'): [1.557407724654902, 1.557407724654902, 1.557407724654902, 1.557407724654902, 1.557407724654902, 0.0], ('Date Type', 'float64'): [0.3664214821954433, 0.14397822594653087, 1.126558072365633, -1.942858872324553, -0.315386518264285, 1.970110944960366], ('age', 'float64'): [4.535204837744809, 4.535204837744809, 4.535204837744809, 4.535204837744809, 4.535204837744809, 4.535204837744809], ('function', 'float64'): [nan, nan, nan, nan, nan, nan], ('names', 'float64'): [nan, nan, nan, nan, nan, nan], ('timestamp', 'float64'): [1.126558072365633, 1.126558072365633, 1.126558072365633, 1.126558072365633, 1.126558072365633, 1.126558072365633], ('weight(t)', 'float64'): [2.2858478773669804, -2.185039863261519, 1.1578212823495775, -4.286261674628062, -0.6597305715207762, nan]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
 ...
 'timestamp': [Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00')],
 'weight(t)': [4.3, 2.0, 4.0, 1.8, 5.7, nan],
 'wt': [2.2858478773669804, -2.185039863261519, 1.1578212823495775, -4.286261674628062, -0.6597305715207762, nan]}
        self.assertEqual(json_encoding(result), json_encoding(expected))
    ...
    def test_cols_sin_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'float64'): [-0.27090578830786904, -0.9613974918795568, 0.7625584504796028, 0.4201670368266409, nan, -0.9997558399011495]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    
    def test_cols_atanh(self):
        df = self.create_dataframe(dict={('atanh_test', 'float64'): [nan, nan, 9.0, -703.0, -inf, 0.0]}, force_data_types=True)
        result = df.cols.atanh(cols=['atanh_test'])
        expected = self.create_dataframe(dict={('atanh_test', 'float64'): [nan, nan, nan, nan, nan, 0.0]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
 ...
 'timestamp': [Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00')],
 'weight(t)': [4.3, 2.0, 4.0, 1.8, 5.7, nan],
 'wt': [-0.9161659367494549, 0.9092974268256817, -0.7568024953079282, 0.9738476308781951, -0.5506855425976376, nan]}
        self.assertEqual(json_encoding(result), json_encoding(expected))
    
    def test_cols_asinh_numeric(self):
        df = self.df.cols.select(['height(ft)'])
        result = df.cols.asinh(cols=['height(ft)'])
        expected = self.create_dataframe(dict={('height(ft)', 'float64'): [-4.025670415869822, 3.5272244561999657, 3.9516133360820653, 3.2595725562629214, nan, 6.39693243298235]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    
    def test_cols_sinh(self):
        df = self.create_dataframe(dict={('sinh_test', 'object'): [inf, '3.141592', -2.7182, 0, None, 5000]}, force_data_types=True)
        result = df.cols.sinh(cols=['sinh_test'])
        expected = self.create_dataframe(dict={('sinh_test', 'float64'): [inf, 1.862295545067587, -1.72535430656715, 0.0, nan, 9.210340381976183]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
 ...
 'timestamp': [Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00'), Timestamp('2014-06-24 00:00:00')],
 'weight(t)': [4.3, 2.0, 4.0, 1.8, 5.7, nan],
 'wt': [2.1379586186848787, 1.3169578969248166, 2.0634370688955608, 1.1929107309930491, 2.42582831808226, nan]}
        self.assertEqual(json_encoding(result), json_encoding(expected))
 ...
 'wt': [nan, nan, nan, nan, nan, nan]}
    ...
    def test_cols_asinh(self):
        df = self.create_dataframe(dict={('asinh_test', 'float64'): [nan, nan, 1.0, -0.34, inf, 13.0]}, force_data_types=True)
        result = df.cols.asinh(cols=['asinh_test'])
        expected = self.create_dataframe(dict={('asinh_test', 'float64'): [nan, nan, 0.881373587019543, -0.3337683516458822, inf, 3.2595725562629214]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    ...
    def test_cols_cosh_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'float64'): [723128532145.7375, 12077476.37678767, 97864804714.41939, 221206.6960055904, nan, 9.712131976206279e+129]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
 ...
 'wt': [nan, nan, nan, nan, nan, nan]}
    ...
    def test_cols_tan_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'float64'): [0.28142960456426525, 3.4939156454748397, 1.17875355420628, 0.4630211329364896, nan, 45.244742070819356]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    
    def test_cols_cosh(self):
        df = self.create_dataframe(dict={('cosh_test', 'object'): [inf, '-3.141592', 2.7182, 0, None, -5000]}, force_data_types=True)
        result = df.cols.cosh(cols=['cosh_test'])
        expected = self.create_dataframe(dict={('cosh_test', 'float64'): [inf, 11.59194572738583, 7.609507839025955, 1.0, nan, inf]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    ...
    def test_cols_sin(self):
        ...
        expected = self.create_dataframe(dict={('sin_test', 'float64'): [-0.009999179777050456, nan, -0.42815542808445156, 0.0, nan, 0.5440211108893699]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    
    def test_cols_cosh_all(self):
        df = self.df
        result = df.cols.cosh(cols='*')
        expected = self.create_dataframe(dict={('NullType', 'float64'): [nan, nan, nan, nan, nan, nan], ('attributes', 'float64'): [nan, nan, nan, nan, nan, nan], ('date arrival', 'float64'): [nan, nan, nan, nan, nan, nan], ('function(binary)', 'float64'): [nan, nan, nan, nan, nan, nan], ('height(ft)', 'float64'): [723128532145.7375, 12077476.37678767, 97864804714.41939, 221206.6960055904, nan, 9.712131976206279e+129], ('japanese name', 'float64'): [nan, nan, nan, nan, nan, nan], ('last date seen', 'float64'): [nan, nan, nan, nan, nan, nan], ('last position seen', 'float64'): [nan, nan, nan, nan, nan, nan], ('rank', 'float64'): [11013.232920103323, 548.3170351552121, 548.3170351552121, 1490.479161252178, 11013.232920103323, 1490.479161252178], ('Cybertronian', 'float64'): [1.5430806348152437, 1.5430806348152437, 1.5430806348152437, 1.5430806348152437, 1.5430806348152437, 1.0], ('Date Type', 'float64'): [inf, inf, inf, inf, inf, inf], ('age', 'float64'): [inf, inf, inf, inf, inf, inf], ('function', 'float64'): [nan, nan, nan, nan, nan, nan], ('names', 'float64'): [nan, nan, nan, nan, nan, nan], ('timestamp', 'float64'): [inf, inf, inf, inf, inf, inf], ('weight(t)', 'float64'): [36.85668112930399, 3.7621956910836314, 27.308232836016487, 3.1074731763172663, 149.43537346625888, nan]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
    ...
    def test_cols_tan(self):
        ...
        expected = self.create_dataframe(dict={('tan_test', 'float64'): [0.009999679691514851, nan, -0.10658787210537021, 0.0, nan, 0.8559934009085189]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True))
