...
class TestTrigonometricPandas(TestBase):
    ...
    def test_cols_acosh_numeric(self):
        ...
        expected = self.create_dataframe(dict={('height(ft)', 'float64'): [nan, 3.5254943480781717, 3.95087369077445, 3.2566139548000526, nan, 6.396926877426794]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
    ...
    def test_cols_sinh(self):
        ...
        expected = self.create_dataframe(dict={('sinh_test', 'float64'): [inf, 1.8622955450675873, -1.72535430656715, 0.0, nan, 9.210340381976183]}, force_data_types=True)
        self.assertTrue(result.equals(expected, decimal=True, assertion=True))
