...
class TestMoreStatisticsPandas(TestBase):
    ...
    def test_cols_frequency_all(self):
        df = self.create_dataframe(dict={('vf', 'float64'): [9.9, 9.9, 9.9, 9.9, 3.3000000000000003, 3.3000000000000003, 3.3000000000000003, 22.0, 22.0, 1.1, 1.1, 0.0, 4.4], ('vs', 'object'): ['STR9', 'STR9', 'STR9', 'STR9', 'STR3', 'STR3', 'STR3', 'STR20', 'STR20', 'STR1', 'STR1', 'STR0', 'STR4'], ('values', 'int64'): [9, 9, 9, 9, 3, 3, 3, 20, 20, 1, 1, 0, 4], ('o', 'object'): ['nine', [9], {'nine': 9}, 9, 3, 3, 3, None, None, 1, 1, 1, 1]}, force_data_types=True)
        result = df.cols.frequency(cols='*', n=10, count_uniques=True)
        expected = {'frequency': {'vf': {'values': [{'value': 9.9, 'count': 4}, {'value': 3.3000000000000003, 'count': 3}, {'value': 1.1, 'count': 2}, {'value': 22.0, 'count': 2}, {'value': 0.0, 'count': 1}, {'value': 4.4, 'count': 1}], 'count_uniques': 6}, 'vs': {'values': [{'value': 'STR9', 'count': 4}, {'value': 'STR3', 'count': 3}, {'value': 'STR1', 'count': 2}, {'value': 'STR20', 'count': 2}, {'value': 'STR0', 'count': 1}, {'value': 'STR4', 'count': 1}], 'count_uniques': 6}, 'values': {'values': [{'value': 9, 'count': 4}, {'value': 3, 'count': 3}, {'value': 1, 'count': 2}, {'value': 20, 'count': 2}, {'value': 0, 'count': 1}, {'value': 4, 'count': 1}], 'count_uniques': 6}, 'o': {'values': [{'value': 1, 'count': 4}, {'value': 3, 'count': 3}, {'value': 9, 'count': 1}, {'value': [9], 'count': 1}, {'value': 'nine', 'count': 1}, {'value': {'nine': 9}, 'count': 1}], 'count_uniques': 6}}}
        self.assertTrue(results_equal(result, expected, decimal=5, assertion=True))

    def test_cols_frequency_multiple(self):
        df = self.create_dataframe(dict={('vf', 'float64'): [9.9, 9.9, 9.9, 9.9, 3.3000000000000003, 3.3000000000000003, 3.3000000000000003, 22.0, 22.0, 1.1, 1.1, 0.0, 4.4], ('vs', 'object'): ['STR9', 'STR9', 'STR9', 'STR9', 'STR3', 'STR3', 'STR3', 'STR20', 'STR20', 'STR1', 'STR1', 'STR0', 'STR4'], ('values', 'int64'): [9, 9, 9, 9, 3, 3, 3, 20, 20, 1, 1, 0, 4], ('o', 'object'): ['nine', [9], {'nine': 9}, 9, 3, 3, 3, None, None, 1, 1, 1, 1]}, force_data_types=True)
        result = df.cols.frequency(cols=['vs', 'vf'], n=6, percentage=True)
        expected = {'frequency': {'vs': {'values': [{'value': 'STR9', 'count': 4, 'percentage': 30.77}, {'value': 'STR3', 'count': 3, 'percentage': 23.08}, {'value': 'STR1', 'count': 2, 'percentage': 15.38}, {'value': 'STR20', 'count': 2, 'percentage': 15.38}, {'value': 'STR0', 'count': 1, 'percentage': 7.69}, {'value': 'STR4', 'count': 1, 'percentage': 7.69}]}, 'vf': {'values': [{'value': 9.9, 'count': 4, 'percentage': 30.77}, {'value': 3.3000000000000003, 'count': 3, 'percentage': 23.08}, {'value': 1.1, 'count': 2, 'percentage': 15.38}, {'value': 22.0, 'count': 2, 'percentage': 15.38}, {'value': 0.0, 'count': 1, 'percentage': 7.69}, {'value': 4.4, 'count': 1, 'percentage': 7.69}]}}}
        self.assertTrue(results_equal(result, expected, decimal=5, assertion=True))

    def test_cols_frequency_numeric(self):
        df = self.create_dataframe(dict={('vf', 'float64'): [9.9, 9.9, 9.9, 9.9, 3.3000000000000003, 3.3000000000000003, 3.3000000000000003, 22.0, 22.0, 1.1, 1.1, 0.0, 4.4], ('vs', 'object'): ['STR9', 'STR9', 'STR9', 'STR9', 'STR3', 'STR3', 'STR3', 'STR20', 'STR20', 'STR1', 'STR1', 'STR0', 'STR4'], ('values', 'int64'): [9, 9, 9, 9, 3, 3, 3, 20, 20, 1, 1, 0, 4], ('o', 'object'): ['nine', [9], {'nine': 9}, 9, 3, 3, 3, None, None, 1, 1, 1, 1]}, force_data_types=True)
        result = df.cols.frequency(cols='values', n=4, percentage=True, total_rows=3)
        expected = {'frequency': {'values': {'values': [{'value': 9, 'count': 4, 'percentage': 30.77}, {'value': 3, 'count': 3, 'percentage': 23.08}, {'value': 1, 'count': 2, 'percentage': 15.38}, {'value': 20, 'count': 2, 'percentage': 15.38}]}}}
        self.assertTrue(results_equal(result, expected, decimal=5, assertion=True))

    def test_cols_frequency_string(self):
        df = self.create_dataframe(dict={('vf', 'float64'): [9.9, 9.9, 9.9, 9.9, 3.3000000000000003, 3.3000000000000003, 3.3000000000000003, 22.0, 22.0, 1.1, 1.1, 0.0, 4.4], ('vs', 'object'): ['STR9', 'STR9', 'STR9', 'STR9', 'STR3', 'STR3', 'STR3', 'STR20', 'STR20', 'STR1', 'STR1', 'STR0', 'STR4'], ('values', 'int64'): [9, 9, 9, 9, 3, 3, 3, 20, 20, 1, 1, 0, 4], ('o', 'object'): ['nine', [9], {'nine': 9}, 9, 3, 3, 3, None, None, 1, 1, 1, 1]}, force_data_types=True)
        result = df.cols.frequency(cols='vs', n=5, percentage=False)
        expected = {'frequency': {'vs': {'values': [{'value': 'STR9', 'count': 4}, {'value': 'STR3', 'count': 3}, {'value': 'STR1', 'count': 2}, {'value': 'STR20', 'count': 2}, {'value': 'STR4', 'count': 1}]}}}
        self.assertTrue(results_equal(result, expected, decimal=5, assertion=True))
