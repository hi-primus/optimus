...
```
pip install --upgrade --no-deps --force-reinstall git+https://github.com/hi-primus/optimus.git@develop-22.1
```
...
pip install --upgrade --force-reinstall git+https://github.com/hi-primus/optimus.git@develop-22.1
...
![Inheritance](https://raw.githubusercontent.com/hi-primus/optimus/develop-22.1/readme/images/inheritance.jpg)
